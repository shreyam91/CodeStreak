...
const TaskForm = () => {
  ...
  <input
    type="" // You might want to specify type to "time" or "text" depending on your use case
    id="due-timewithIn"
    value={withinTime}
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m3-9h-2M9 2h6a1 1 0 011 1v1H8V3a1 1 0 011-1zM12 22a9 9 0 100-18 9 9 0 000 18z" />
        ...
        <button
          type="submit"
          className="whitespace-nowrap rounded-md bg-indigo-600 px-6 py-3 font-semibold text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
          Submit
        </button>
      </div>
